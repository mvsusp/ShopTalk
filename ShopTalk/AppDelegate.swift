...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
    ...
    Parse.setApplicationId("x9mZm65n8i0chRs0tztvmEcl800xfnYlOv2zrYZi",
      clientKey: "Q4r6yiUf6lRsuwHoksjHTRLZam0lFpY7yQwENeO2")
    
    // [Optional] Track statistics around application opens.
    PFAnalytics.trackAppOpenedWithLaunchOptions(launchOptions)

    registerForParseNotifications(application, launchOptions: launchOptions)
  ...
  func registerForParseNotifications(application: UIApplication, launchOptions: [NSObject: AnyObject]?) {
